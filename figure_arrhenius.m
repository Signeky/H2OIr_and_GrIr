...
x_07 = [1/xh, 1/xc];
y_07 = [log(yh), log(yc)];
y_07_error = [yh_error/yh, yc_error/yc]; %Error through error propagation 
...
alpha0_error_07_135 = sqrt((yh_error*exp(Ea_07/(6.24150974E21*BoltzmannConstant*135)))^2+(Ea_error_07*yh*exp(Ea_07/(6.24150974E21*BoltzmannConstant*135))/(BoltzmannConstant*6.24150974E21*135))^2)*1e-3;
alpha0_error_07_125 = sqrt((yc_error*exp(Ea_07/(6.24150974E21*BoltzmannConstant*125)))^2+(Ea_error_07*yc*exp(Ea_07/(6.24150974E21*BoltzmannConstant*125))/(BoltzmannConstant*6.24150974E21*125))^2)*1e-3;
...
Ea_07_alternative_error = sqrt(((yc_error/yc)*6.24150974E21*BoltzmannConstant*125)^2+((alpha0_GrNi_error/alpha0_GrNi)*6.24150974E21*BoltzmannConstant*125)^2);
